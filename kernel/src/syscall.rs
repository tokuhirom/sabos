...
fn dispatch_inner(nr: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) -> Result<u64, SyscallError> {
    match nr {
        ...
        SYS_NET_DNS_LOOKUP => sys_net_dns_lookup(arg1, arg2, arg3),
        SYS_NET_TCP_CONNECT => sys_net_tcp_connect(arg1, arg2),
        SYS_NET_TCP_SEND => sys_net_tcp_send(arg1, arg2, arg3),
        SYS_NET_TCP_RECV => sys_net_tcp_recv(arg1, arg2, arg3, arg4),
        SYS_NET_TCP_CLOSE => sys_net_tcp_close(arg1),
        ...
        SYS_NET_TCP_LISTEN => sys_net_tcp_listen(arg1),
        SYS_NET_TCP_ACCEPT => sys_net_tcp_accept(arg1, arg2),
        SYS_NET_UDP_BIND => sys_net_udp_bind(arg1),
        SYS_NET_UDP_SEND_TO => sys_net_udp_send_to(arg1),
        SYS_NET_UDP_RECV_FROM => sys_net_udp_recv_from(arg1),
        SYS_NET_UDP_CLOSE => sys_net_udp_close(arg1),
        SYS_NET_PING6 => sys_net_ping6(arg1, arg2, arg3),
        // ハンドル
        ...
        SYS_IPC_RECV_FROM => sys_ipc_recv_from(arg1, arg2, arg3, arg4),
...
///   読み取ったバイト数（成功時）
///   負の値（エラー時）
fn sys_ipc_recv_from(arg1: u64, arg2: u64, arg3: u64, arg4: u64) -> Result<u64, SyscallError> {
...
///
/// 戻り値: 0（成功）、負（エラー）
fn sys_net_tcp_send(arg1: u64, arg2: u64, arg3: u64) -> Result<u64, SyscallError> {
...
///
/// 戻り値: 0（成功）、負（エラー）
fn sys_net_tcp_listen(arg1: u64) -> Result<u64, SyscallError> {
...
fn sys_net_udp_bind(arg1: u64) -> Result<u64, SyscallError> {
    let port = arg1 as u16;
...
///
/// 戻り値: 0（成功）、負（エラー）
fn sys_net_udp_send_to(arg1: u64) -> Result<u64, SyscallError> {
    // UdpSendToArgs を読み取る
...
///
/// 戻り値: 0（成功）、負（エラー）
fn sys_net_udp_close(arg1: u64) -> Result<u64, SyscallError> {
