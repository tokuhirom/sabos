...
- テスト対象: メモリアロケータ、ページング、スケジューラ、virtio-blk、FAT32、IPC、ハンドル操作、syscall、ネットワーク、GUI、サーバーデーモン、9P 等（64 項目）
...
シェルで `selftest` を実行すると各サブシステムをテストする（64 項目）:
